...
BOOL CmfcServer1App::InitInstance()
{
    ...
    //WriteProfileString("LogInfo", "UserName", "hehe@123"); //向注册表HKEY_CURRENT_USER//software//mfcServer1//LogInfo//分支下写入 UserName 字符串行键值
    CmfcServer1Dlg dlg;
    m_pMainWnd = &dlg;
